...
(function ($) {
  ...
  var Multifarious = {
    ...
    locTestimonial: function () {
      var TestimonSwiper = new Swiper(
        ".loc_testimonial_slider .swiper-container",
        {
          autoHeight: false,
          autoplay: false,
          loop: true,
    ...
    /*-----------------------------------------------------
			...
			-----------------------------------------------------*/
    TeamSlider: function () {
      var TeamSwiper = new Swiper(
        ".team_slider.swiper-container, .pc_service_slider.swiper-container",
        {
          autoHeight: false,
          autoplay: true,
          spaceBetween: 30,
    ...
    gymTestimonial: function () {
      var TestimonialSwiper = new Swiper(
        ".swiper-container.s1, .d_rclass_wrapper .swiper-container, .d_testi_wrapper .swiper-container",
        {
          autoHeight: false,
          autoplay: false,
          loop: true,
    ...
    /*-----------------------------------------------------
			...
			-----------------------------------------------------*/
    gymPartner: function () {
      var partnersSwiper = new Swiper(
        ".gym_partner_slider.swiper-container, .saf_partner_slider.swiper-container, .pc_partner_slider.swiper-container",
        {
          autoHeight: false,
          autoplay: true,
          spaceBetween: 30,
    ...
    drTestimonial: function () {
      var testimonialSwiper = new Swiper(
        ".swiper-container.arrowNavTestimonials",
        {
          autoHeight: false,
          autoplay: false,
          loop: true,
    ...
    saloonTestimonial: function () {
      var saloonTestimonialSwiper = new Swiper(
        ".swiper-container.saloonTestimonial",
        {
          autoHeight: false,
          autoplay: true,
          loop: true,
    ...
    golBanner: function () {
      var bannerSwiper = new Swiper(
        ".swiper-container.gol_banner_slider, .swiper-container.vot_banner_slider, .swiper-container.dr_banner_slider, .swiper-container.sal_banner_slider, .swiper-container.saf_banner_slider",
        {
          autoHeight: false,
          autoplay: true,
          loop: true,
    ...
    popupGallery: function () {
      jQuery(document).ready(function () {
        if (
          $(
            ".popup_gallery, .popup_gallery1, .popup_gallery2, .popup_gallery3, .popup_gallery4, .popup_gallery5"
          ).length > 0
        ) {
          $(
            ".popup_gallery, .popup_gallery1, .popup_gallery2, .popup_gallery3, .popup_gallery4, .popup_gallery5 "
    ...
    waTestimonial: function () {
      var TestimonialSwiper = new Swiper(
        ".wa_testimonial_slider .swiper-container.s2",
        {
          autoHeight: false,
          autoplay: false,
          loop: true,
    ...
    isotop_gallery: function () {
      if ($(".gallery_grid").length > 0) {
        ...
        $(".wa_project_gallery > .gallery_nav > ul > li").on(
          "click",
          "a",
          function () {
            // filter button click
    ...
    /*-----------------------------------------------------
			...
			-----------------------------------------------------*/
    d_choregph: function () {
      var choregraphSwiper = new Swiper(
        ".d_choregph_wrapper .swiper-container",
        {
          autoHeight: false,
          autoplay: true,
          spaceBetween: 0,
